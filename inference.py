...
class LLama:
    ...
    def build(checkpoint_dir: str, tokenizer_path: str, load_model: bool,
        ...
        model = Transformer(device=device, args=model_args).to(device)
    ...
    def generate(self, prompts: list, temperature: float = 0.6, top_p: float = 0.9,
                 max_gen_len: Optional[int] = None, istoken: bool = False):
        """
